...
class UserProfile(AbstractUser):
	...
	role = models.ManyToManyField(Role, verbose_name='角色', help_text="角色", related_name="roles")
	team = models.ManyToManyField(Team, verbose_name='班级', help_text="班级", blank=True, related_name="team_users")
